...
angular.module('myApp', ['myApp.authService', 'myApp.commentServices', 'myApp.formService', 'commentCounterAdapter', 'commentList', 'commentItem', 'appHeader', 'appFooter', 'preloader', 'replyForm']);
